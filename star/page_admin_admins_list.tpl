...
<div class="row">
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h3>Admins <i class="btn btn-outline-primary btn-rounded btn-fw" style="width:20px;height:20px;padding:0px;line-height:18px;">管理员总数:{$admin_count}</i></h3>
				<p>
											...
											<td width="30%" style="vertical-align:top !important;">
												<div class="ban-edit">
													...
													<ul class="list-arrow">
														...
														<li>
															<a href="index.php?p=admin&c=admins&o=editservers&id={$admin.aid}"><i class="menu-icon mdi mdi-server-network"></i> 编辑服务器管理权</a>
														</li>
														<li>
															<a href="index.php?p=admin&c=admins&o=editgroup&id={$admin.aid}"><i class="menu-icon mdi mdi-account-multiple"></i> 编辑组</a>
														</li>
														{/if}
												...
												<div>免疫等级: {$admin.immunity}</div>
												<div>上次访问: <small>{$admin.lastvisit}</small></div>
											</td>
										</tr>
									</table>
								</div>

...
<div class="row">
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h3>服务器 <i class="btn btn-outline-primary btn-rounded btn-fw" style="width:20px;height:20px;padding:0px;line-height:18px;">总计服务器:{$server_count}</i></h3>
				<br><br>
				<div id="banlist" class="table-responsive">
					<table class="table table-striped">
						...
						<tr id="sid_{$server.sid}" {if $server.enabled==0}style="background-color:#eaeaea" title="禁用"{/if}>
						<td>{$server.sid}</td>
				...
				<div class="rowdesc">
					...
					上传地图图片
					{sb_button text="上传地图图片" onclick="childWindow=open('pages/admin.uploadmapimg.php','upload','resizable=yes,width=300,height=130');" class="btn-primary" id="upload"}
				</div>
